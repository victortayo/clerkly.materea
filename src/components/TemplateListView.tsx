...
function TemplateRow({ 
  ...
  return (
    ...
    >
      ...
      <td className="px-6 py-4">
        <span className="inline-flex px-2 py-0.5 rounded text-[10px] uppercase font-bold tracking-widest bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-300 border border-slate-200 dark:border-slate-600">
          {template.specialty}
        </span>
      </td>
